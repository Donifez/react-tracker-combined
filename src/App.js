...
export default function App() {
  ...
  <div className="top col-12">
    ...
    <a href="/home"><button type="button" id="log1">Log In</button></a> 
        ...
        <div className="modal-header modal-style">
          ...
          <div className="container ">
            ...
            <h4 className="my-modal-btn-login-text">Sign-up</h4>
              ...
              <br/>
              <a href="home.js"><button type="submit" className="btn btn-primary my-modal-btn-login">Submit</button></a>
...
// fetchData(){
//   fetch('localhost:8009/api/register')
